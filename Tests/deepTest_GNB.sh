...
function BACTERIA_TEST () {
    ...
    do
        ...
        do
            if [[ "$seq" -ge "${training_block_min}" ]] && [[ "$seq" -le "${training_block_max}" ]]; then
            echo -e "\033[1;34m[RFSC]\033[0m Run: $seq";
            python3 src/naiveBayes.py 8 0.8 ${blocks_perc[i]} ${blocks_perc[i+1]} ${DNA_VALUE_1[seq]} ${AA_VALUE_1[seq]} ${DNA_VALUE_3[seq]} ${AA_VALUE_3[seq]} ${DNA_VALUE_7[seq]} ${AA_VALUE_7[seq]} ${GC_VALUE[seq]} ${DNA_LENGTH[seq]} ${AA_LENGTH[seq]} 1111 >> Tests/Predictions/Prediction_Bacteria_CV.txt
            fi
        done
    done
}
...
function ARCHAEA_TEST () {
    ...
    do
        ...
        do
            if [[ "$seq" -ge "${training_block_min}" ]] && [[ "$seq" -le "${training_block_max}" ]]; then
            echo -e "\033[1;34m[RFSC]\033[0m Run: $seq";
            python3 src/naiveBayes.py 8 0.8 ${blocks_perc[i]} ${blocks_perc[i+1]} ${DNA_VALUE_1[seq]} ${AA_VALUE_1[seq]} ${DNA_VALUE_3[seq]} ${AA_VALUE_3[seq]} ${DNA_VALUE_7[seq]} ${AA_VALUE_7[seq]} ${GC_VALUE[seq]} ${DNA_LENGTH[seq]} ${AA_LENGTH[seq]} 1111 >> Tests/Predictions/Prediction_Archaea_CV.txt
            fi
        done
    done
}
...
function FUNGI_TEST () {
    ...
    do
        ...
        do
            if [[ "$seq" -ge "${training_block_min}" ]] && [[ "$seq" -le "${training_block_max}" ]]; then
            echo -e "\033[1;34m[RFSC]\033[0m Run: $seq";
            python3 src/naiveBayes.py 8 0.8 ${blocks_perc[i]} ${blocks_perc[i+1]} ${DNA_VALUE_1[seq]} ${AA_VALUE_1[seq]} ${DNA_VALUE_3[seq]} ${AA_VALUE_3[seq]} ${DNA_VALUE_7[seq]} ${AA_VALUE_7[seq]} ${GC_VALUE[seq]} ${DNA_LENGTH[seq]} ${AA_LENGTH[seq]} 1111 >> Tests/Predictions/Prediction_Fungi_CV.txt
            fi
        done
    done
}
...
function PLANT_TEST () {
    ...
    do
        ...
        do
            if [[ "$seq" -ge "${training_block_min}" ]] && [[ "$seq" -le "${training_block_max}" ]]; then
            echo -e "\033[1;34m[RFSC]\033[0m Run: $seq";
            python3 src/naiveBayes.py 8 0.8 ${blocks_perc[i]} ${blocks_perc[i+1]} ${DNA_VALUE_1[seq]} ${AA_VALUE_1[seq]} ${DNA_VALUE_3[seq]} ${AA_VALUE_3[seq]} ${DNA_VALUE_7[seq]} ${AA_VALUE_7[seq]} ${GC_VALUE[seq]} ${DNA_LENGTH[seq]} ${AA_LENGTH[seq]} 1111 >> Tests/Predictions/Prediction_Plant_CV.txt
            fi
        done
    done
}
...
function PROTOZOA_TEST () {
    ...
    do
        ...
        do
            if [[ "$seq" -ge "${training_block_min}" ]] && [[ "$seq" -le "${training_block_max}" ]]; then
            echo -e "\033[1;34m[RFSC]\033[0m Run: $seq";
            python3 src/naiveBayes.py 8 0.8 ${blocks_perc[i]} ${blocks_perc[i+1]} ${DNA_VALUE_1[seq]} ${AA_VALUE_1[seq]} ${DNA_VALUE_3[seq]} ${AA_VALUE_3[seq]} ${DNA_VALUE_7[seq]} ${AA_VALUE_7[seq]} ${GC_VALUE[seq]} ${DNA_LENGTH[seq]} ${AA_LENGTH[seq]} 1111 >> Tests/Predictions/Prediction_Protozoa_CV.txt
            fi
        done
    done
}
...
function MITO_TEST () {
    ...
    do
        ...
        do
            if [[ "$seq" -ge "${training_block_min}" ]] && [[ "$seq" -le "${training_block_max}" ]]; then
            echo -e "\033[1;34m[RFSC]\033[0m Run: $seq";
            python3 src/naiveBayes.py 8 0.8 ${blocks_perc[i]} ${blocks_perc[i+1]} ${DNA_VALUE_1[seq]} ${AA_VALUE_1[seq]} ${DNA_VALUE_3[seq]} ${AA_VALUE_3[seq]} ${DNA_VALUE_7[seq]} ${AA_VALUE_7[seq]} ${GC_VALUE[seq]} ${DNA_LENGTH[seq]} ${AA_LENGTH[seq]} 1111 >> Tests/Predictions/Prediction_Mitochondrial_CV.txt
            fi
        done
    done
}
...
function PLASTID_TEST () {
    ...
    do
        ...
        do
            if [[ "$seq" -ge "${training_block_min}" ]] && [[ "$seq" -le "${training_block_max}" ]]; then
            echo -e "\033[1;34m[RFSC]\033[0m Run: $seq";
            python3 src/naiveBayes.py 8 0.8 ${blocks_perc[i]} ${blocks_perc[i+1]} ${DNA_VALUE_1[seq]} ${AA_VALUE_1[seq]} ${DNA_VALUE_3[seq]} ${AA_VALUE_3[seq]} ${DNA_VALUE_7[seq]} ${AA_VALUE_7[seq]} ${GC_VALUE[seq]} ${DNA_LENGTH[seq]} ${AA_LENGTH[seq]} 1111 >> Tests/Predictions/Prediction_Plastid_CV.txt
            fi
        done
    done
}
