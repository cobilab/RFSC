...
if [ -n "$FILE1" ]; then
        echo -e "\033[1;34m[RFSC]\033[0m Start File Concat..."
else
	echo -e "\033[1;34m[RFSC] \033[1;31m Argument Error - Insert Reference(s) File(s) \033[0m"
        echo -e "\033[1;34m[RFSC] \033[0;33m Usage: bash mixRefs.sh [FILE1] [FILE2] : [FILE9] \033[0m"
	exit 0
fi
